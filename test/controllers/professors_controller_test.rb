...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { firstname: @professor.firstname, lastname: @professor.lastname, status: @professor.status } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { firstname: @professor.firstname, lastname: @professor.lastname, status: @professor.status } }
